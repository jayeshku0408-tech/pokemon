...
st.markdown("AI-based prediction of **Legendary status** and **Type**")

# Sidebar
st.sidebar.header("🎮 Enter Pokemon Stats")
...
if st.button("🔮 Predict"):
    ...
    if total > 600:
        st.success("💪 Extremely Strong!")
    elif total > 400:
        st.warning("⚔️ متوسط Strength")
    else:
        st.info("🐣 Weak Pokemon")
...
# Footer
st.warning("⚠️ Type prediction accuracy is low (~22%)")